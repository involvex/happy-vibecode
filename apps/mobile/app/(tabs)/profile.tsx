				...
				>
					...
					>
						...
						<View className="bg-card dark:bg-card-dark border border-border dark:border-border-dark rounded-2xl p-4 gap-3">
							...
							<View className="border border-border dark:border-border-dark rounded-xl p-4 gap-2 bg-surface dark:bg-surface-dark">
								<View className="flex-row items-center justify-between">
									<View>
										<Text className="text-muted dark:text-muted-dark text-xs">
											Current plan
									...
									<View className="items-end">
										...
										<Text className="text-text dark:text-text-dark text-sm font-medium capitalize">
